...
import static laptop.deteksimonitor1.jeniskerusakan;
import static laptop.deteksimonitor1.judul;
import static laptop.deteksimonitor1.penyebabkerusakan;
import static laptop.deteksimonitor1.saranusul;
 ...
 */
public class kerusakanmonitor extends javax.swing.JFrame {

    /**
     * Creates new form kerusakanmonitor
     */
    public kerusakanmonitor() {
        initComponents();
    ...
    public void displayTime(){
        ...
        jLabel7.setText(sdf.format(cal.getTime()));         
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 120, 130, 50));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(kerusakanmonitor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
